...
class GroupInfo extends StatefulWidget {
  ...
  final String groupName;
   GroupInfo({Key? key,required this.groupName,required this.groupId,required this.adminName}) : super(key: key);
...
class _GroupInfoState extends State<GroupInfo> {
  ...
  getMember() async{
    DatabaseService(uid: FirebaseAuth.instance.currentUser!.uid).getGroupMembers(widget.groupId).then
      ((val){
        setState(() {
          members = val;
        });
