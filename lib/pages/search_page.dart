 ...
 @override
  ...
  initiateSearchMethod() async{
    if(searchController.text.isNotEmpty){
      ...
      await DatabaseService(uid: '').searchByName(searchController.text).then((snapshot){
        setState(() {
  ...
  groupList(){
    return hasUserSearched ? ListView.builder(
      ...
      itemBuilder: (context,index){
        return groupTile(
          userName,searchSnapshot!.docs[index]["groupId"],searchSnapshot!.docs[index]["groupName"],
...
Future.delayed(Duration(seconds: 2),(){
  Get.to(chatPage(groupName: groupName, groupId: groupId, userName: userName));
});
